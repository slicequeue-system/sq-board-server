...
public class ReadAllArticlesPagingService {

    private final JpaArticleQueryRepository articlePagingQueryRepository;
    private static final int movablePageCount = 10;

    public PageResponse<ArticleListItem> findAll(ReadAllArticlesPagingQuery query) {
        ...
        return PageResponse.of(articles, count);
    }
